...
import { Radiation, Stethoscope, HeartPulse, ClipboardCheck, Check, Bone } from "lucide-react"
...
export default function ServiciosHome() {
  const servicios = [
    ...
    },
    {
      ...
      especial: true,
      color: "bg-[#0B2CF5]",
      icon: <Check className="w-7 h-7" strokeWidth={3} />
    },
    {
      title: "CHEQ-IN Óseo",
      suffix: "Óseo",
      ...
      especial: true,
      color: "bg-[#E8BC3D]",
      icon: <Bone className="w-7 h-7" strokeWidth={2.5} />
    },
    {
