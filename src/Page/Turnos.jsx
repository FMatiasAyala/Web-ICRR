  ...
  return (
    <>
      <SeoTags
        ...
        description="Reservá tu turno online para resonancias, tomografías o ecografías en el Consultorio Radiológico Resistencia."
        ...
        <div className="container mx-auto px-6 grid gap-10 sm:grid-cols-2 lg:grid-cols-4">
          {contactos.map((c, i) => (
            ...
            >
              ...
              {/* Telefono */}
              <div className="flex flex-row items-center text-[#2E86AB] font-medium text-sm text-center">
